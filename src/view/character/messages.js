...
export const messages = {
  ...
  tips: {
    select: {
      [FeatureIds.STANDARD_ARRAY]: "The standard values from 15 down to 8. Ability scores may be rearranged using drag and drop.",
  ...
  ["point buy cost"]: "Point Cost to Increase Score",
  ["point sell value"]: "Point Return to Decrease Score"
};
